...
1. Choose the icon ![Lightbulb that opens the Tell Me feature](../images/install-activate/tell-me-icon.png), Enter Extension Management, and the choose the related link.

2. Choose from the menu AppSource Gallery.

![AppSource Gallery](../images/install-activate/appsource-gallery.png)
